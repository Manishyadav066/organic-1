        ...
        <div class="row py-3 border-bottom">
            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                  ...
                  <li><a href="pages/cart.php" class="dropdown-item">Cart</a></li>
                  <li><a href="checkout.php" class="dropdown-item">Checkout</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a href="pages/login.php" class="dropdown-item">Login / My Account</a></li>
                  <li><a href="pages/register.php" class="dropdown-item">Register</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a href="admin/login.php" class="dropdown-item fw-bold text-success">Admin / Seller Panel</a></li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              ...
              <li>
                <a href="#" class="p-2 mx-1 position-relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                  <svg width="24" height="24"><use xlink:href="#shopping-bag"></use></svg>
                  <span class="cart-badge badge bg-primary position-absolute top-0 start-100 translate-middle rounded-pill">0</span>
                </a>
              </li>
            </ul>
          </div>
